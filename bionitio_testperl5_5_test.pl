...
# Unit tests for bionitio_testperl5_5.
#
# usage: perl bionitio_testperl5_5_test.pl

use strict;
use warnings 'FATAL' => 'all';
use Test::More;
use IO::String;
require 'bionitio_testperl5_5.pl';

# Test wrapper for the process_file function from bionitio_testperl5_5.
#
# Arguments:
