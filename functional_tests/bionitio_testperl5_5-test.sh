...
this_program_name="bionitio_testperl5_5-test.sh"
...
${this_program_name}: run integration/regression tests for bionitio_testperl5_5 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/bionitio_testperl5_5 -d data/tests
