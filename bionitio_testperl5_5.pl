...
# Module      : bionitio_testperl5_5.pl
...
#        does not exist at the specified path, or bionitio_testperl5_5 does not have permission
#        to read from the file.
# 2: A command line error occurred. This can happen if the user specifies
#        an incorrect command line argument. In this circumstance bionitio_testperl5_5 will
...
sub init_logging {
    ...
    $logger = get_logger('Bionitio_testperl5_5');
